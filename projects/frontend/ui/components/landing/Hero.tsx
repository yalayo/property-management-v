...
import { ArrowRight, Star, BarChart, Home, Clock, Zap } from "lucide-react";
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
            <h1 className="text-4xl tracking-tight font-extrabold sm:text-5xl md:text-6xl lg:mt-6">
              ...
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-500">{t("hero.headline2")}</span>
            </h1>
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="font-medium">{t("hero.features.financialTracking")}</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="font-medium">{t("hero.features.propertyManagement")}</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="font-medium">{t("hero.features.automatedReminders")}</div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="font-medium">{t("hero.features.fastAI")}</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 sm:mt-8 flex items-center text-sm text-gray-500">
              ...
              <Star className="h-4 w-4 text-yellow-500 mr-1" fill="currentColor" />
              <Star className="h-4 w-4 text-yellow-500 mr-1" fill="currentColor" />
              <span className="ml-1">{t("hero.trusted")}</span>
            </div>
          </div>
              ...
              <div className="aspect-w-16 aspect-h-9">
                <div className="h-96 bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center p-8">
                  ...
                  <div className="relative z-10 text-white text-center">
                    ...
                    <h3 className="text-2xl font-bold mb-2">{t("hero.modernTitle")}</h3>
