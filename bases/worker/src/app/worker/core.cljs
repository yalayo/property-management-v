...
(defn init [{:keys [user-routes settings-routes price-routes request-routes]}]
  (let [routes (into base-routes (concat user-routes settings-routes price-routes request-routes))
