...
(defn init [{:keys [user-routes survey-routes plans-routes property-routes settings-routes price-routes request-routes]}]
  (let [routes (into base-routes (concat user-routes survey-routes plans-routes property-routes settings-routes price-routes request-routes))
